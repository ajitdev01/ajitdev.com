...
const PAGES = {
  leetcode: {
    ...
    desc: "Review Ajit Dev's LeetCode coding stats. Solved 400+ problems, algorithm complexity optimizations, tree/graph structures, and competitive contest ratings.",
  ...
  achievements: {
    ...
    content: `
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <ul className="list-disc list-inside text-sm text-gray-600 space-y-3 mb-6">
          <li><strong>LeetCode Consistency</strong>: Completed 400+ algorithmic problems, maintaining a 150+ day active streak.</li>
    ...
    `,
    faq: [
      { q: "What is Ajit Dev's longest coding streak?", a: "He has maintained a daily coding streak exceeding 150 consecutive days on LeetCode." }
    ]
  },
  certificates: {
