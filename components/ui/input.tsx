      ...
      return (
        <div className="relative flex items-center w-full">
          ...
          <input
            type={type}
            className={cn(
              "flex h-11 w-full rounded-2xl border border-slate-200/90 bg-white px-3.5 py-2 text-sm font-bold text-slate-900 shadow-2xs transition-all duration-200 file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-slate-400 hover:border-slate-300 focus-visible:outline-hidden focus-visible:border-indigo-600 focus-visible:ring-3 focus-visible:ring-indigo-500/20 focus-visible:shadow-[0_0_15px_-3px_rgba(99,102,241,0.25)] disabled:cursor-not-allowed disabled:opacity-50",
