...
export const metadata: Metadata = {
  ...
  description: "Discover React.js frontend engineering. Reusable component designs, custom hooks, virtual DOM, and animations with Framer Motion.",
  alternates: {
    canonical: "https://ajitdev.com/react",
  },
};
...
export default function ReactPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/react/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What React state manager is preferred?",
        "answer": {
          "@type": "Answer",
          "text": "Zustand is preferred for small-to-medium states, while Redux Toolkit is deployed for large enterprise graphs."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              High-performance frontend library optimized for declarative rendering, reactive state loops, virtual DOM reconciliation, and fluid visual design interfaces.
            </p>
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We focus on building accessible (WCAG compliant) designs with smooth animations and layout states to optimize user experiences.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">React Official Documentation</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Framer Motion API</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Tailwind UI Components</span>
            </div>
          </div>
