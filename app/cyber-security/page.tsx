...
export const metadata: Metadata = {
  ...
  description: "Explore application security auditing. Defending Express backends against OWASP Top 10 vulnerabilities, encrypting tokens, and securing API limits.",
  alternates: {
    canonical: "https://ajitdev.com/cyber-security",
  },
};
...
export default function CyberSecurityPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/cyber-security/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 2,
        "name": "cyber security",
        "item": "https://ajitdev.com/cyber-security",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is an OWASP injection flaw?",
        "answer": {
          "@type": "Answer",
          "text": "A weakness where user input is executed directly as backend commands (e.g. SQL commands), compromising data tables."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Auditing application code to prevent data leaks, SQL injections, authorization bypasses, and insecure communications.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              <li>OWASP Top 10 Risks</li>
              <li>Data Encryption Standards</li>
              <li>Secure Auth Systems</li>
              <li>API Limit Hardening</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We configure backends utilizing express rate limiters, helmet header tags, JWT token sign keys, and sanitized SQL parameters.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">OWASP Cheat Sheets</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Helmet Middleware API</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">CORS Routing Rules</span>
            </div>
          </div>
