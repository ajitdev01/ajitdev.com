...
export const metadata: Metadata = {
  title: "Binary Search Algorithms Study Notes & scaling | Ajit Dev",
  description: "Logarithmic ranges search, sorting checkpoints, and search boundaries. Master class implementation notes, tradeoffs analysis, and scaling parameters in DSA.",
  alternates: {
...
export default function dsaBinarySearchPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/dsa/binary-search/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 3,
        "name": "binary search",
        "item": "https://ajitdev.com/dsa/binary-search",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is covered under this Binary Search Algorithms guide?",
        "answer": {
          "@type": "Answer",
          "text": "This guide covers implementation guidelines, common trade-offs, scalability checkpoints, and clean code configurations for Binary Search Algorithms."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          Here is my learning journal and notes on <strong>Binary Search Algorithms</strong>:
        </p>
