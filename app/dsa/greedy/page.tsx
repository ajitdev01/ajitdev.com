...
export const metadata: Metadata = {
  title: "Greedy Algorithms Study Notes & scaling | Ajit Dev",
  description: "Optimal localized decisions, minimizing paths, and coin change solutions. Master class implementation notes, tradeoffs analysis, and scaling parameters in DSA.",
  alternates: {
...
export default function dsaGreedyPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/dsa/greedy/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 3,
        "name": "greedy",
        "item": "https://ajitdev.com/dsa/greedy",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is covered under this Greedy Algorithms guide?",
        "answer": {
          "@type": "Answer",
          "text": "This guide covers implementation guidelines, common trade-offs, scalability checkpoints, and clean code configurations for Greedy Algorithms."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          Here is my learning journal and notes on <strong>Greedy Algorithms</strong>:
        </p>
