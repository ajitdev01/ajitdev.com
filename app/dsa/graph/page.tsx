...
export const metadata: Metadata = {
  title: "Graph Data Structures Study Notes & scaling | Ajit Dev",
  description: "Nodes connected by edges, DFS/BFS traversals, path routing algorithms. Master class implementation notes, tradeoffs analysis, and scaling parameters in DSA.",
  alternates: {
...
export default function dsaGraphPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/dsa/graph/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 3,
        "name": "graph",
        "item": "https://ajitdev.com/dsa/graph",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is covered under this Graph Data Structures guide?",
        "answer": {
          "@type": "Answer",
          "text": "This guide covers implementation guidelines, common trade-offs, scalability checkpoints, and clean code configurations for Graph Data Structures."
        }
      },
      {
        "@type": "Question",
    ...
    <>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-gray-500 text-sm mt-2 leading-relaxed">
              Nodes connected by edges, DFS/BFS traversals, path routing algorithms.
            </p>
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          ...
          Here is my learning journal and notes on <strong>Graph Data Structures</strong>:
        </p>
