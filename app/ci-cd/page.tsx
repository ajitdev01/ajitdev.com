...
export const metadata: Metadata = {
  ...
  description: "Discover CI/CD pipelines logic. Deploying packages, static analyzers, and zero-downtime server updates.",
  alternates: {
    canonical: "https://ajitdev.com/ci-cd",
  },
};
...
export default function CiCdPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/ci-cd/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
    ...
    "mainEntity": [
      {
        ...
        "answer": {
          "@type": "Answer",
          "text": "Updating servers without dropping client connections, often by utilizing rolling updates or blue-green route switches."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Automating application updates from coding environments to active servers. Eliminating manual deployment checklists and code compile errors.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              <li>Commit Hook Automation</li>
              <li>Unit & Lint Testing</li>
              <li>Container Registries Build</li>
              <li>Rolling Server Deploys</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We construct pipelines checking lint rules, SAST syntax patterns, and SCA dependencies before pushing containers to AWS nodes.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">CI/CD Best Practices</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Trivy Scanner Docs</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">AWS Deploy Rules</span>
            </div>
          </div>
