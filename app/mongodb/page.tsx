...
export const metadata: Metadata = {
  ...
  description: "Learn MongoDB document schema design. Sharding collections, aggregation builders, compound indices, and atlas cluster hosting.",
  alternates: {
    canonical: "https://ajitdev.com/mongodb",
  },
};
...
export default function MongodbPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/mongodb/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 2,
        "name": "mongodb",
        "item": "https://ajitdev.com/mongodb",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is an aggregation pipeline?",
        "answer": {
          "@type": "Answer",
          "text": "A sequence of document processing stages (e.g. match, group, project) that output calculated data summaries."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Document-oriented database storing JSON-like document maps. Highly scalable, supporting dynamic aggregates and distributed shard nodes.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              ...
              <li>Indexes & Shards</li>
              <li>Aggregation Frameworks</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We structure schemas using Mongoose middleware models, optimizing compound index layouts to minimize read latencies.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">MongoDB Manual</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Atlas Cloud Setup</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Mongoose Schemas</span>
            </div>
          </div>
