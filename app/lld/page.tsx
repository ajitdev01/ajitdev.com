...
export const metadata: Metadata = {
  ...
  description: "Learn Low Level Design (LLD) parameters. UML class structures, OOP design patterns (Factory, Singleton), and SOLID rules.",
  alternates: {
    canonical: "https://ajitdev.com/lld",
  },
};
...
export default function LldPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/lld/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is the SOLID S rule?",
        "answer": {
          "@type": "Answer",
          "text": "Single Responsibility Principle: A class or function must have exactly one reason to change, handling one clear task."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Detailed code design structures. Mapping UML classes, SOLID interface patterns, thread safeties, and data models schemas.
            </p>
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We write modular code complying with SOLID principles to keep software extensible and easily testable.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Design Patterns Book</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Refactoring Guru</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Clean Code Guides</span>
            </div>
          </div>
