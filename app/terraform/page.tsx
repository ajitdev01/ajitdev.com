...
export const metadata: Metadata = {
  ...
  description: "Learn about declarative cloud provisioning. Writing modular Terraform templates for AWS VPCs, Route53, and security policies.",
  alternates: {
    canonical: "https://ajitdev.com/terraform",
  },
};
...
export default function TerraformPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/terraform/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 2,
        "name": "terraform",
        "item": "https://ajitdev.com/terraform",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Why use Terraform over AWS Console?",
        "answer": {
          "@type": "Answer",
          "text": "It provides version-controlled configurations, visual dependency tracking, and repeatable infrastructure states."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Declarative infrastructure as code. Creating version-controlled, repeatable configurations to provision AWS subnets, EC2 nodes, and database clusters.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              <li>HCL Language Syntax</li>
              <li>State Files & Backends</li>
              <li>Terraform Modules Design</li>
              <li>Plan & Apply Operations</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We maintain state configurations securely using remote S3 locks and DynamoDB checkpoints to prevent setup conflicts.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Terraform Registry</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">HCL Guides</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">AWS Module Repos</span>
            </div>
          </div>
