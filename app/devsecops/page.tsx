...
export const metadata: Metadata = {
  ...
  description: "Explore DevSecOps practices by Ajit Dev. Shifting security left, configuring SAST static scanners (Trivy, Snyk), and container build auditing.",
  alternates: {
    canonical: "https://ajitdev.com/devsecops",
  },
};
...
export default function DevsecopsPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/devsecops/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 2,
        "name": "devsecops",
        "item": "https://ajitdev.com/devsecops",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is SAST vs DAST?",
        "answer": {
          "@type": "Answer",
          "text": "SAST scans source code patterns for syntax issues, while DAST queries running APIs to find runtime security holes."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Securing continuous delivery pipelines by integrating automated security scans (SAST, DAST, dependency checks) directly inside the delivery loop.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              <li>Vulnerability Auditing Basics</li>
              <li>Static Analysis (SAST) Setup</li>
              <li>Dependency Scans (SCA)</li>
              <li>Container Audits (Trivy)</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We enforce rules blocking pull requests if any dependency displays known CVE reports, resolving security flaws early.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">OWASP Top 10 Guides</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Snyk Scanner APIs</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Trivy Checklists</span>
            </div>
          </div>
