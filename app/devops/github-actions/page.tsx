...
export const metadata: Metadata = {
  title: "GitHub Actions Pipelines Study Notes & scaling | Ajit Dev",
  description: "YAML continuous integration rules, testing scripts, and automated deployments. Master class implementation notes, tradeoffs analysis, and scaling parameters in DevOps.",
  alternates: {
    canonical: "https://ajitdev.com/devops/github-actions",
  },
};

export default function devopsGithubActionsPage() {
  const breadcrumbSchema = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/devops/github-actions/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 3,
        "name": "github actions",
        "item": "https://ajitdev.com/devops/github-actions",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is covered under this GitHub Actions Pipelines guide?",
        "answer": {
          "@type": "Answer",
          "text": "This guide covers implementation guidelines, common trade-offs, scalability checkpoints, and clean code configurations for GitHub Actions Pipelines."
        }
      },
      {
        "@type": "Question",
    ...
    <>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-gray-500 text-sm mt-2 leading-relaxed">
              YAML continuous integration rules, testing scripts, and automated deployments.
            </p>
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Deployment guides, build commands, and script templates for <strong>GitHub Actions Pipelines</strong> operations.
        </p>
        ...
        <div className="bg-slate-900 border border-gray-800 rounded-xl p-5 mb-8 font-mono text-xs text-emerald-400">
          <span className="text-gray-500 block mb-2"># CLI Cheat Sheet commands for GitHub Actions Pipelines</span>
          $ npm run build <br />
