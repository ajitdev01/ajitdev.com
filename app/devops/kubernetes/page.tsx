...
export const metadata: Metadata = {
  title: "Kubernetes Cluster Pods Study Notes & scaling | Ajit Dev",
  description: "Configuring replica sets, ingress DNS routes, and pod scheduling manifests. Master class implementation notes, tradeoffs analysis, and scaling parameters in DevOps.",
  alternates: {
    canonical: "https://ajitdev.com/devops/kubernetes",
  },
};

export default function devopsKubernetesPage() {
  const breadcrumbSchema = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/devops/kubernetes/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 3,
        "name": "kubernetes",
        "item": "https://ajitdev.com/devops/kubernetes",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is covered under this Kubernetes Cluster Pods guide?",
        "answer": {
          "@type": "Answer",
          "text": "This guide covers implementation guidelines, common trade-offs, scalability checkpoints, and clean code configurations for Kubernetes Cluster Pods."
        }
      },
      {
        "@type": "Question",
    ...
    <>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-gray-500 text-sm mt-2 leading-relaxed">
              Configuring replica sets, ingress DNS routes, and pod scheduling manifests.
            </p>
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Deployment guides, build commands, and script templates for <strong>Kubernetes Cluster Pods</strong> operations.
        </p>
        ...
        <div className="bg-slate-900 border border-gray-800 rounded-xl p-5 mb-8 font-mono text-xs text-emerald-400">
          <span className="text-gray-500 block mb-2"># CLI Cheat Sheet commands for Kubernetes Cluster Pods</span>
          $ npm run build <br />
