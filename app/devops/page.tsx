...
export const metadata: Metadata = {
  ...
  description: "Review DevOps engineering layouts. Configuring CI/CD pipelines, container runtime orchestration, Nginx reverse proxy routes, and Linux server hardening.",
  alternates: {
    canonical: "https://ajitdev.com/devops",
  },
};
...
export default function DevopsPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/devops/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
    ...
    "mainEntity": [
      {
        ...
        "answer": {
          "@type": "Answer",
          "text": "Integrating automated vulnerability scans early in the developer coding cycle, before code reaches staging databases."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Unifying software development and system operations. Developing automated infrastructure templates, continuous testing, container packages, and cluster scaling controls.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              ...
              <li>Infrastructure Code (Terraform)</li>
              <li>Orchestrations (Kubernetes)</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We configure pipelines ensuring code maps correctly to packages and servers execute with minimal downtime parameters.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">DevOps Roadmaps</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Interactive Bash Scripts</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Infrastructure Guides</span>
            </div>
          </div>
