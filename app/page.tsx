                ...
                <motion.h1 variants={fadeUp} className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight leading-tight text-gray-900">
                  <span className="relative inline-block pb-2">
                    <motion.span
                      ...
                      className="inline-block bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 bg-clip-text text-transparent bg-[length:200%_auto]"
                    >
                      Full Stack Engineer
                    </motion.span>
                    <motion.span
                      ...
                      className="absolute bottom-0 left-0 w-full h-[4px] bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 origin-left rounded-full"
                    />
                  </span>
                </motion.h1>
