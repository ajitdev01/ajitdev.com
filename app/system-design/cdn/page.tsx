...
export const metadata: Metadata = {
  title: "Content Delivery Networks (CDN) Study Notes & scaling | Ajit Dev",
  description: "Caching static media assets close to clients using global edge nodes. Master class implementation notes, tradeoffs analysis, and scaling parameters in System Design.",
  alternates: {
    canonical: "https://ajitdev.com/system-design/cdn",
  },
};

export default function systemdesignCdnPage() {
  const breadcrumbSchema = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/system-design/cdn/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 3,
        "name": "cdn",
        "item": "https://ajitdev.com/system-design/cdn",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is covered under this Content Delivery Networks (CDN) guide?",
        "answer": {
          "@type": "Answer",
          "text": "This guide covers implementation guidelines, common trade-offs, scalability checkpoints, and clean code configurations for Content Delivery Networks (CDN)."
        }
      },
      {
        "@type": "Question",
    ...
    <>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-gray-500 text-sm mt-2 leading-relaxed">
              Caching static media assets close to clients using global edge nodes.
            </p>
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Detailed notes, trade-offs, and scaling guidelines for <strong>Content Delivery Networks (CDN)</strong> systems.
        </p>
