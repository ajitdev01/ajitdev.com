...
export const metadata: Metadata = {
  title: "Database Scaling Patterns Study Notes & scaling | Ajit Dev",
  description: "Relational replicas, write sharding rules, and indexing large data sets. Master class implementation notes, tradeoffs analysis, and scaling parameters in System Design.",
  alternates: {
    canonical: "https://ajitdev.com/system-design/database-scaling",
  },
};

export default function systemdesignDatabaseScalingPage() {
  const breadcrumbSchema = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/system-design/database-scaling/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "item": "https://ajitdev.com/system-design/database-scaling",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is covered under this Database Scaling Patterns guide?",
        "answer": {
          "@type": "Answer",
          "text": "This guide covers implementation guidelines, common trade-offs, scalability checkpoints, and clean code configurations for Database Scaling Patterns."
        }
      },
      {
        "@type": "Question",
    ...
    <>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-gray-500 text-sm mt-2 leading-relaxed">
              Relational replicas, write sharding rules, and indexing large data sets.
            </p>
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Detailed notes, trade-offs, and scaling guidelines for <strong>Database Scaling Patterns</strong> systems.
        </p>
