...
export const metadata: Metadata = {
  title: "Load Balancing Servers Study Notes & scaling | Ajit Dev",
  description: "Distributing requests across compute nodes using Round Robin and hash methods. Master class implementation notes, tradeoffs analysis, and scaling parameters in System Design.",
  alternates: {
    canonical: "https://ajitdev.com/system-design/load-balancer",
  },
};

export default function systemdesignLoadBalancerPage() {
  const breadcrumbSchema = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/system-design/load-balancer/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 3,
        "name": "load balancer",
        "item": "https://ajitdev.com/system-design/load-balancer",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is covered under this Load Balancing Servers guide?",
        "answer": {
          "@type": "Answer",
          "text": "This guide covers implementation guidelines, common trade-offs, scalability checkpoints, and clean code configurations for Load Balancing Servers."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Detailed notes, trade-offs, and scaling guidelines for <strong>Load Balancing Servers</strong> systems.
        </p>
