...
export const metadata: Metadata = {
  title: "Designing Uber Ride Sharing Study Notes & scaling | Ajit Dev",
  description: "Geospatial queries, matching drivers, and processing real-time location logs. Master class implementation notes, tradeoffs analysis, and scaling parameters in System Design.",
  alternates: {
    canonical: "https://ajitdev.com/system-design/design-uber",
  },
};

export default function systemdesignDesignUberPage() {
  const breadcrumbSchema = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/system-design/design-uber/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 3,
        "name": "design uber",
        "item": "https://ajitdev.com/system-design/design-uber",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is covered under this Designing Uber Ride Sharing guide?",
        "answer": {
          "@type": "Answer",
          "text": "This guide covers implementation guidelines, common trade-offs, scalability checkpoints, and clean code configurations for Designing Uber Ride Sharing."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Detailed notes, trade-offs, and scaling guidelines for <strong>Designing Uber Ride Sharing</strong> systems.
        </p>
