...
export const metadata: Metadata = {
  title: "Message Queues & Brokers Study Notes & scaling | Ajit Dev",
  description: "Handling async background tasks using RabbitMQ or Kafka log brokers. Master class implementation notes, tradeoffs analysis, and scaling parameters in System Design.",
  alternates: {
    canonical: "https://ajitdev.com/system-design/message-queues",
  },
};

export default function systemdesignMessageQueuesPage() {
  const breadcrumbSchema = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/system-design/message-queues/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 3,
        "name": "message queues",
        "item": "https://ajitdev.com/system-design/message-queues",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is covered under this Message Queues & Brokers guide?",
        "answer": {
          "@type": "Answer",
          "text": "This guide covers implementation guidelines, common trade-offs, scalability checkpoints, and clean code configurations for Message Queues & Brokers."
        }
      },
      {
        "@type": "Question",
    ...
    <>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Detailed notes, trade-offs, and scaling guidelines for <strong>Message Queues & Brokers</strong> systems.
        </p>
