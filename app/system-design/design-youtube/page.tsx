...
export const metadata: Metadata = {
  title: "Designing YouTube Video Platform Study Notes & scaling | Ajit Dev",
  description: "Uploading files, processing formats, CDN distribution, and metadata databases. Master class implementation notes, tradeoffs analysis, and scaling parameters in System Design.",
  alternates: {
    canonical: "https://ajitdev.com/system-design/design-youtube",
  },
};

export default function systemdesignDesignYoutubePage() {
  const breadcrumbSchema = {
    "@context": "https://schema.org",
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/system-design/design-youtube/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 3,
        "name": "design youtube",
        "item": "https://ajitdev.com/system-design/design-youtube",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is covered under this Designing YouTube Video Platform guide?",
        "answer": {
          "@type": "Answer",
          "text": "This guide covers implementation guidelines, common trade-offs, scalability checkpoints, and clean code configurations for Designing YouTube Video Platform."
        }
      },
      {
        "@type": "Question",
    ...
    <>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-black tracking-tight text-gray-900 leading-tight">
              Designing YouTube Video Platform
            </h1>
            <p className="text-gray-500 text-sm mt-2 leading-relaxed">
              Uploading files, processing formats, CDN distribution, and metadata databases.
            </p>
          </div>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
        ...
        <p className="text-gray-600 mb-6 leading-relaxed">
          Detailed notes, trade-offs, and scaling guidelines for <strong>Designing YouTube Video Platform</strong> systems.
        </p>
