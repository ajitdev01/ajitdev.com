...
export const metadata: Metadata = {
  ...
  description: "Review AWS cloud deployment setups. IAM access rules, private subnets VPC routing, EC2 instances, and serverless Lambda functions.",
  alternates: {
    canonical: "https://ajitdev.com/aws",
  },
};
...
export default function AwsPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/aws/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is AWS IAM?",
        "answer": {
          "@type": "Answer",
          "text": "Identity and Access Management, controlling which roles and keys can make AWS API calls."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Cloud systems provisioning. VPC setups, IAM access security boundaries, EC2 computing instances, and Lambda serverless integrations.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              <li>VPC Subnet Architectures</li>
              <li>IAM Role Policies</li>
              <li>EC2 & Load Balancers</li>
              <li>Lambda & API Gateways</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We configure networks privately, routing app servers inside isolated zones with NAT gateways handling egress APIs.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">AWS Documentation</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Terraform AWS Modules</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">AWS Architecture Guidelines</span>
            </div>
          </div>
