...
export const metadata: Metadata = {
  ...
  description: "Learn about MERN stack development. Designing secure MongoDB aggregates, Express routes, React.js frontends, and Node.js APIs.",
  alternates: {
    canonical: "https://ajitdev.com/mern-stack",
  },
};
...
export default function MernStackPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/mern-stack/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 2,
        "name": "mern stack",
        "item": "https://ajitdev.com/mern-stack",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is Ajit Dev's MERN experience?",
        "answer": {
          "@type": "Answer",
          "text": "Ajit Dev has built and deployed multiple e-commerce, reservation, and SaaS products using the MERN stack."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Modern javascript stack leveraging MongoDB document models, Express.js middleware routing, React.js interactive components, and Node.js backend execution engines.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              ...
              <li>Express REST Controllers</li>
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We construct secure MERN dashboards deploying JWT tokens, custom middleware limiters, helmet headers, and database shards to handle concurrent traffic.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">React Docs</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">NodeJS Best Practices</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">MongoDB University</span>
            </div>
          </div>
