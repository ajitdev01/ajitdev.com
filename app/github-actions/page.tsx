...
export const metadata: Metadata = {
  ...
  description: "Review CI/CD workflow automation. Writing YAML manifests for static bundle compilation, unit checks, and Docker registry builds.",
  alternates: {
    canonical: "https://ajitdev.com/github-actions",
  },
};
...
export default function GithubActionsPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/github-actions/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 2,
        "name": "github actions",
        "item": "https://ajitdev.com/github-actions",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is a workflow trigger?",
        "answer": {
          "@type": "Answer",
          "text": "An event (e.g. push to main, pull request) that starts the execution of an automated pipeline."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Continuous integration and delivery configurations. Automating code tests, typescript compiler checks, code packaging, and cloud node deployments directly from code updates.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              <li>Workflow Yaml Syntax</li>
              <li>Actions Runner Environments</li>
              <li>Matrix Builds & Variables</li>
              <li>Secrets & Deployment Keys</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We secure continuous workflows by loading target secrets, managing access tokens, and implementing static code scanning checkpoints.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">GitHub Actions Docs</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Docker Actions Marketplace</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Security Auditing Pipelines</span>
            </div>
          </div>
