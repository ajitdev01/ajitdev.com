...
export const metadata: Metadata = {
  ...
  description: "Review High Level Design (HLD) patterns. Load balancer placements, microservices mapping, caching layouts, and message queues configurations.",
  alternates: {
    canonical: "https://ajitdev.com/hld",
  },
};
...
export default function HldPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/hld/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is a message queue useful for?",
        "answer": {
          "@type": "Answer",
          "text": "Managing asynchronous communications, allowing backends to process compute tasks without locking user requests."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              High level software architecture planning. Constructing network diagrams, server nodes, cache placements, databases, and message brokers.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              <li>High Level Architecture Basics</li>
              <li>Load Balancing Topologies</li>
              <li>Data Replication Models</li>
              <li>Message Broker Placements</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We build network designs emphasizing decoupling, redundancy, and eliminating single points of failures.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Distributed Systems Guides</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">AWS Architectural Patterns</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Message Queuing Protocols</span>
            </div>
          </div>
