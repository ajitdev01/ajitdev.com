...
export const metadata: Metadata = {
  ...
  description: "Review cloud security practices by Ajit Dev. Multi-layer VPC subnets, AWS IAM access credentials, and network encryption parameters.",
  alternates: {
    canonical: "https://ajitdev.com/cloud-security",
  },
};
...
export default function CloudSecurityPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/cloud-security/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 2,
        "name": "cloud security",
        "item": "https://ajitdev.com/cloud-security",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is zero-trust cloud network?",
        "answer": {
          "@type": "Answer",
          "text": "An infrastructure design where all resource queries require explicit identity verification, ignoring internal locations."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Protecting cloud infrastructure. Designing isolated VPC subnets, access boundary rules, TLS routes, and cloud resource auditing.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              ...
              <li>IAM Policies & Roles</li>
              <li>Threat Logging & Audits</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We implement least-privilege configurations, ensuring API keys have minimal access parameters, and logging network request cycles.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">AWS Security Whitepapers</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Terraform Security Analyzers</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">CIS Benchmarks</span>
            </div>
          </div>
