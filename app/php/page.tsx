...
export const metadata: Metadata = {
  ...
  description: "Discover PHP backend operations. Prepared SQL queries, dependency composer managers, MVC structures, and server integrations.",
  alternates: {
    canonical: "https://ajitdev.com/php",
  },
};
...
export default function PhpPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/php/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is composer in PHP?",
        "answer": {
          "@type": "Answer",
          "text": "It is the dependency manager for PHP, similar to npm in Node.js, compiling vendor directories."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Server scripting language powering content management platforms and database backends globally. Supporting strict types and MVC architectures.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              ...
              <li>Composer Packages Control</li>
              <li>PDO Database Transactions</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We use modern PHP ES8 features, securing prepared statements and PDO drivers to safeguard data entries.
            </p>
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              ...
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Composer Docs</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">PHP-FIG Standards</span>
            </div>
          </div>
