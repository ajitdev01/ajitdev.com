...
export const metadata: Metadata = {
  ...
  description: "Review JavaScript ES6+ language guides. Closures, asynchronous promise loops, prototypes, and array performance structures.",
  alternates: {
    canonical: "https://ajitdev.com/javascript",
  },
};
...
export default function JavascriptPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/javascript/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 2,
        "name": "javascript",
        "item": "https://ajitdev.com/javascript",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "Is JavaScript single threaded?",
        "answer": {
          "@type": "Answer",
          "text": "Yes, JavaScript is single threaded but leverages Node/Browser background APIs to manage async tasks."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              The language of the web. Custom operations, event loops, call stacks, scope chains, and asynchronous architectures.
            </p>
            ...
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We follow clean code guidelines, eliminating memory leaks, and writing dry code structure elements.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">MDN Web Docs</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">JavaScript Info</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Eloquent JavaScript Book</span>
            </div>
          </div>
