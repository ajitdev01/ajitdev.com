...
export const metadata: Metadata = {
  ...
  description: "Explore TypeScript static typing rules. Interfaces, generic methods, utility parameters, and compiler configurations.",
  alternates: {
    canonical: "https://ajitdev.com/typescript",
  },
};
...
export default function TypescriptPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/typescript/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 2,
        "name": "typescript",
        "item": "https://ajitdev.com/typescript",
      },
    ],
  };
    ...
    "mainEntity": [
      {
        ...
        "answer": {
          "@type": "Answer",
          "text": "It provides autocomplete, maps backend API payloads to variables, and catches syntax errors before delivery."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Strict type superset compile layer for JavaScript, ensuring structural compile-time safety, contract APIs, and fewer runtime errors.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              ...
              <li>TS Config Tuning</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We implement absolute strict configurations, eliminating any 'any' types, and mapping interfaces to models.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">TypeScript Handbook</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">TS Playground</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Strict Mode Guidelines</span>
            </div>
          </div>
