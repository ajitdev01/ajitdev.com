...
export const metadata: Metadata = {
  title: "DevOps Engineering Tutorials | Ajit Dev Blog",
  description:
    "Production-grade DevOps playbooks on Docker, Kubernetes, CI/CD with GitHub Actions, Linux administration, and Infrastructure as Code by Ajit Dev from Katihar, Bihar.",
  alternates: {
    canonical: "https://ajitdev.com/blog/devops",
  },
};
...
export default function DevOpsCategoryPage() {
  ...
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/blog/devops/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 3,
        "name": "DevOps",
        "item": "https://ajitdev.com/blog/devops",
      },
    ],
  };
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What topics are covered in the DevOps category?",
        "answer": {
          "@type": "Answer",
          "text": "The DevOps category covers continuous integration (CI), continuous deployment (CD), containerization with Docker, orchestration with Kubernetes, automation scripts in Linux, and Terraform infrastructure management.",
        },
      },
    ],
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
              Automate builds, containerize deployments, and configure declarative infrastructures. Learn standard systems integration patterns and cluster deployments.
            </p>
          </div>
          ...
          {posts.length > 0 ? (
            ...
            <div className="p-12 text-center bg-white border border-gray-200 rounded-2xl">
              ...
              <p className="text-gray-500 text-sm font-semibold mb-2">No DevOps articles published yet.</p>
