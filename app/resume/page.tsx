...
export default function ResumePage() {
  ...
  const techStack = [
    ...
    { label: "Frontend", tags: ["HTML5", "CSS3", "React", "Next.js", "Tailwind CSS", "Bootstrap", "Radix UI", "Framer Motion"] },
    ...
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 print:px-0 print:max-w-full">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6 print:hidden">
            ...
            <div className="flex flex-wrap items-center gap-2">
              <a
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-white text-slate-700 border border-slate-200 hover:bg-slate-50 font-extrabold text-xs rounded-xl shadow-2xs transition-all no-underline"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-slate-100 text-slate-700 hover:bg-slate-200 font-extrabold text-xs rounded-xl transition-all cursor-pointer"
              >
          ...
          {viewMode === "pdf" ? (
            <div className="rounded-3xl border border-slate-200 bg-white p-4 sm:p-6 shadow-xl shadow-slate-200/80">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 mb-4 rounded-2xl bg-indigo-50/80 border border-indigo-100">
                <div className="flex items-center gap-3">
                  <div className="p-3 bg-indigo-600 text-white rounded-xl shadow-xs">
                    <FileText className="w-5 h-5" />
                  </div>
                  <div>
                    <h3 className="text-sm sm:text-base font-black text-slate-900">AJIT_KUMAR.pdf</h3>
                    <p className="text-xs font-semibold text-slate-500">Official Software Engineer & DevOps Resume (PDF Document)</p>
                  </div>
                </div>
