...
export const metadata: Metadata = {
  ...
  description: "Explore MySQL database schemas. Foreign key constraints, inner join transactions, view indices, and backup utilities.",
  alternates: {
    canonical: "https://ajitdev.com/mysql",
  },
};
...
export default function MysqlPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/mysql/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is a primary key constraint?",
        "answer": {
          "@type": "Answer",
          "text": "A rule that uniquely identifies each row in a table, indexing it for optimal retrieval speeds."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Relational database server deploying SQL query structures, foreign key constraints, indexes, transaction checks, and backups.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              ...
              <li>Backup & Dump Setup</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We check queries using EXPLAIN commands to verify indexes are hit, preventing database locks during high traffic.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">MySQL Reference Manual</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">SQL Cheat Sheets</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Explain Query Tuning</span>
            </div>
          </div>
