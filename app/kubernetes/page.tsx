...
export const metadata: Metadata = {
  ...
  description: "Discover Kubernetes operations by Ajit Dev. Managing node pods, rolling updates, ingress routing, and config file specifications.",
  alternates: {
    canonical: "https://ajitdev.com/kubernetes",
  },
};
...
export default function KubernetesPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/kubernetes/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
      ...
      },
      {
        ...
        "position": 2,
        "name": "kubernetes",
        "item": "https://ajitdev.com/kubernetes",
      },
    ],
  };
    ...
    "mainEntity": [
      {
        ...
        "answer": {
          "@type": "Answer",
          "text": "The smallest deployable unit in Kubernetes, wrapping one or more containers sharing storage and network configs."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Orchestrating container groups across computing nodes. Automating deployment rollouts, horizontal scaling, ingress proxies, and configuration volumes.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              <li>K8s Architecture Components</li>
              <li>Pod & Deployment Manifests</li>
              <li>Ingress Controllers & DNS</li>
              <li>EKS Cluster Deployments</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We manage resources using namespace segmentations, network rules, config maps, and rolling update controls to guarantee high availability.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Kubernetes Docs</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Helm Chart Templates</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Minikube Local Setup</span>
            </div>
          </div>
