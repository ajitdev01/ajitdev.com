...
export const metadata: Metadata = {
  ...
  description: "Learn Next.js App Router performance tuning. Optimizing server rendering (SSR), static generation (SSG), dynamic metadata, and SEO rules.",
  alternates: {
    canonical: "https://ajitdev.com/nextjs",
  },
};
...
export default function NextjsPage() {
  const breadcrumbSchema = {
    ...
    "@type": "BreadcrumbList",
    "@id": "https://ajitdev.com/nextjs/#breadcrumb",
    "itemListElement": [
      {
        "@type": "ListItem",
        "position": 1,
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      {
        "@type": "Question",
        "name": "What is Ajit Dev's Next.js setup?",
        "answer": {
          "@type": "Answer",
          "text": "This portfolio is built on Next.js 15+ using App Router, tailwind utility layout grids, and typescript controllers."
        }
      }
    ]
  };
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-8 shadow-sm">
            ...
            <p className="text-gray-600 leading-relaxed mb-6">
              Enterprise React framework supporting server components, client-side hydration, automatic route splitting, static site generation, and PageSpeed metrics optimization.
            </p>
            ...
            <ul className="list-disc list-inside text-sm text-gray-600 space-y-2 mb-6">
              ...
              <li>Data Fetching & ISR</li>
              <li>Edge Renders & Middleware</li>
            </ul>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Notes & Implementation Guidelines</h3>
            <p className="text-gray-600 text-sm leading-relaxed mb-6">
              We utilize next.js metadata APIs, dynamic robots, dynamic sitemaps, and preconnect optimization to achieve 100/100 Lighthouse performance metrics.
            </p>

            <h3 className="text-lg font-bold text-gray-900 mb-3">Recommended Learning Resources</h3>
            <div className="flex flex-wrap gap-2 mb-6">
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">NextJS Documentation</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Vercel Speed Insights</span>
              <span className="px-3 py-1 bg-gray-50 border border-gray-100 rounded-lg text-xs font-medium text-gray-500">Lighthouse Performance Rules</span>
            </div>
          </div>
