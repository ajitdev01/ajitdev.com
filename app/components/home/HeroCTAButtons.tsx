  ...
  return (
    ...
    >
      ...
      <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
        <Link
          href="/projects"
          className="group inline-flex items-center gap-2 px-6 sm:px-7 py-3.5 rounded-xl font-bold text-xs sm:text-base text-slate-700 bg-white/80 hover:bg-white border border-slate-200/90 hover:border-indigo-300 shadow-2xs hover:shadow-md hover:text-indigo-600 transition-all duration-200 select-none"
        >
