      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <motion.div 
            ...
            className="group relative bg-white/90 backdrop-blur-md rounded-3xl p-8 border border-slate-200/80 shadow-xs hover:shadow-2xl hover:shadow-blue-500/10 hover:border-blue-400/80 transition-all duration-300 flex flex-col justify-between"
          >
            <div>
              <div className="w-13 h-13 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-650 flex items-center justify-center text-white mb-6 shadow-md shadow-blue-500/25 group-hover:scale-105 transition-transform duration-300 ring-1 ring-white/20">
            ...
            <Link 
              href="/education" 
              className="group/btn w-full mt-auto inline-flex items-center justify-between px-5 py-3 rounded-2xl bg-blue-50/80 border border-blue-200/80 text-blue-700 font-extrabold text-xs transition-all duration-300 hover:bg-blue-600 hover:text-white hover:border-blue-600 hover:shadow-md hover:shadow-blue-600/25"
            >
          ...
          <motion.div 
            variants={fadeUp} 
            whileHover={{ y: -6, transition: { duration: 0.25, ease: "easeOut" } }}
            className="group relative bg-white/90 backdrop-blur-md rounded-3xl p-8 border border-slate-200/80 shadow-xs hover:shadow-2xl hover:shadow-purple-500/10 hover:border-purple-400/80 transition-all duration-300 flex flex-col justify-between"
          >
            <div>
              <div className="w-13 h-13 rounded-2xl bg-gradient-to-br from-purple-500 to-indigo-600 flex items-center justify-center text-white mb-6 shadow-md shadow-purple-500/25 group-hover:scale-105 transition-transform duration-300 ring-1 ring-white/20">
            ...
            <Link 
              href="/education" 
              className="group/btn w-full mt-auto inline-flex items-center justify-between px-5 py-3 rounded-2xl bg-purple-50/80 border border-purple-200/80 text-purple-700 font-extrabold text-xs transition-all duration-300 hover:bg-purple-600 hover:text-white hover:border-purple-600 hover:shadow-md hover:shadow-purple-600/25"
            >
          ...
          <motion.div 
            variants={fadeUp} 
            whileHover={{ y: -6, transition: { duration: 0.25, ease: "easeOut" } }}
            className="group relative bg-white/90 backdrop-blur-md rounded-3xl p-8 border border-slate-200/80 shadow-xs hover:shadow-2xl hover:shadow-emerald-500/10 hover:border-emerald-400/80 transition-all duration-300 flex flex-col justify-between"
          >
            <div>
              <div className="w-13 h-13 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center text-white mb-6 shadow-md shadow-emerald-500/25 group-hover:scale-105 transition-transform duration-300 ring-1 ring-white/20">
            ...
            <Link 
              href="/education" 
              className="group/btn w-full mt-auto inline-flex items-center justify-between px-5 py-3 rounded-2xl bg-emerald-50/80 border border-emerald-200/80 text-emerald-700 font-extrabold text-xs transition-all duration-300 hover:bg-emerald-600 hover:text-white hover:border-emerald-600 hover:shadow-md hover:shadow-emerald-600/25"
            >
