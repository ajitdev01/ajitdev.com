...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "518+ optimized Data Structures & Algorithms solutions with detailed time/space complexity analysis. Daily practice following NeetCode roadmap — Arrays, Trees, Graphs, Recursion, and Dynamic Programming.",
    shortDescription: "518+ LeetCode solutions • Complexity analysis • Daily streak",
    ...
    features: ["518+ Solutions", "Complexity Analysis", "Clean Code", "STL Usage", "Pattern Problems", "Competitive Programming", "Weekly Contests"],
    complexity: "Intermediate",
    stars: 82,
