...
export const projects = [
  ...
  },
  {
    ...
    description: "450+ optimized Data Structures & Algorithms solutions with detailed time/space complexity analysis. Daily practice following NeetCode roadmap — Arrays, Trees, Graphs, Recursion, and Dynamic Programming.",
    shortDescription: "450+ LeetCode solutions • Complexity analysis • Daily streak",
    ...
    features: ["450+ Solutions", "Complexity Analysis", "Clean Code", "STL Usage", "Pattern Problems", "Competitive Programming", "Weekly Contests"],
    complexity: "Intermediate",
    stars: 82,
