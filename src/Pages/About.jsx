...
import {
  ...
  FiMail, FiGithub, FiLinkedin, FiSend, FiBookOpen,
...
const personSchema = {
  ...
  description: "Ajit Kumar is a Full Stack Engineer from Katihar, Bihar, India, specializing in MERN Stack, Next.js, TypeScript, and scalable web applications.",
  ...
  knowsAbout: [
    ...
    "MongoDB", "Express.js", "Tailwind CSS", "JavaScript",
...
const About = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        {/* Core SEO */}
        <title>Ajit Kumar | Full Stack Engineer — MERN, Next.js, TypeScript | Katihar, India</title>
        <meta
          name="description"
          content="Ajit Kumar is a Full Stack Engineer from Katihar, Bihar, India specializing in MERN Stack, Next.js, TypeScript, and scalable web applications. Available for remote opportunities."
        />
        ...
        <meta property="og:title" content="Ajit Kumar | Full Stack Engineer — MERN & Next.js Developer" />
        <meta property="og:description" content="Full Stack Engineer from Katihar, Bihar specializing in MERN Stack, Next.js, TypeScript. View projects and hire for opportunities." />
        ...
        <meta name="twitter:title" content="Ajit Kumar | Full Stack Engineer" />
        <meta name="twitter:description" content="Full Stack Engineer specializing in MERN Stack, Next.js, and TypeScript." />
        ...
        <main className="pt-20 pb-16" id="main-content">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                ...
                <motion.div variants={fadeInUp} className="mb-6">
                  <img
                    ...
                    className="w-full max-w-sm mx-auto rounded-2xl shadow-lg border border-gray-200"
                    loading="lazy"
                  />
                </motion.div>
                ...
                <motion.div variants={fadeInUp} className="space-y-3">
                  {contactDetails.map((detail) => (
                    ...
                    >
                      <detail.icon className="w-5 h-5 text-blue-600 flex-shrink-0" />
                      <div>
              ...
              >
                ...
                <motion.div variants={fadeInUp} className="mb-8">
                  ...
                  <div className="space-y-4 text-gray-700 leading-relaxed">
                    ...
                    <p>
                      <Link to="/projects" className="text-blue-600 font-medium hover:text-blue-700 hover:underline inline-flex items-center gap-1">
                        View my projects <FiExternalLink className="w-3 h-3" />
                      </Link>{" "}
                      to see my work in action, or{" "}
                      <Link to="/skills" className="text-blue-600 font-medium hover:text-blue-700 hover:underline">
                ...
                <motion.div variants={fadeInUp} className="mb-8">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    {skills.map((skill) => (
                      ...
                      >
                        <skill.icon className="w-5 h-5 text-white mx-auto mb-1" />
            ...
            <nav className="sr-only" aria-label="SEO navigation">
              <ul>
                <li><Link to="/">Full Stack Developer India — Home</Link></li>
                <li><Link to="/about">About Ajit Kumar — Full Stack Engineer</Link></li>
                <li><Link to="/projects">MERN Stack Projects Portfolio</Link></li>
                <li><Link to="/skills">Full Stack Skills — React Node.js MongoDB</Link></li>
                <li><Link to="/contact">Hire Full Stack Developer — Contact</Link></li>
              </ul>
            </nav>
